...
const PATH_TO_FILE_USERS = "./src/json/user.json";
const ERROR_PARSED_JSON = "Ошибка разбора JSON: ";
const MESSAGE_ADD_WISH =
  "В следующем сообщении напиши '/wish ' и далее текст желания или ссылку на желаемую вещь:";
...
const MESSAGE_MANAGE_ITEM = "Управляй желанием:";
